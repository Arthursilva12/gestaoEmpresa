											...
											<div class="col-sm-12">
												...
												<div class="card">
													<div class="card-block">
														...
														<form class="form-material" action="<%=request.getContextPath()%>/ServletFones" method="post" id="formFone">
												...
												<tbody>
													<c:forEach items='${modelTelefones}' var='f'>
														<tr>
															...
															<td><a class="btn btn-success" href="<%=request.getContextPath()%>/ServletFones?acao=excluir&id=${f.id}&userpai=${modelLogin.id}">Excluir</a></td>
														</tr>
													</c:forEach>
												</tbody>
											</table>
