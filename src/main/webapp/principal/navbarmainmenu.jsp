                              ...
                              <li class="pcoded-hasmenu">
                                  ...
                                  <ul class="pcoded-submenu">
                                      <c:if test="${perfil == 'ADMIN'}">
	                                      <li class="">
	                                          <a href="<%=request.getContextPath()%>/ServletLoginUsuarioController?acao=listarUser" class="waves-effect waves-dark">
                          ...
                          <ul class="pcoded-item pcoded-left-item">
                              ...
                              <li>
                                  <a href="<%=request.getContextPath()%>/principal/relusergrafico.jsp" class="waves-effect waves-dark">
                                      <span class="pcoded-micon"><i class="ti-layers"></i><b>FC</b></span>
                                      <span class="pcoded-mtext" data-i18n="nav.form-components.main">Gráfico Salários</span>
                                      <span class="pcoded-mcaret"></span>
                                  </a>
                              </li>
                          </ul>
