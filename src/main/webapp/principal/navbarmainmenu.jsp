...
<!-- Menus de navegação abaixo da foto -->
		...
		<div class="p-15 p-b-0">
			<form class="form-material">
				<div class="form-group form-primary">
					...
					<span class="form-bar"></span> <label class="float-label"><i class="fa fa-search m-r-10"></i>Search Friend</label>
				</div>
			</form>
		</div>
...
=======
						<a href="<%=request.getContextPath()%>/ServletLoginUsuarioControler" class="waves-effect waves-dark"> 
>>>>>>> dev
