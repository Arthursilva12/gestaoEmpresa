...
public class ServletFones extends ServletGenericUtil {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if(acao != null && !acao.isEmpty() && acao.equals("excluir")) {
				...
				return;// return; faz com que ao executar esse bloco, o codigo para de rodar aqui e não executa o resto.
			}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if(!daoTelefoneRepository.existeFone(numero, Long.parseLong(usuario_pai_id))) {
				...
				daoTelefoneRepository.gravarFone(modelTelefone);
